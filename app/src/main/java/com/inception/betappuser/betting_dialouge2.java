...
public class betting_dialouge2 extends Dialog implements View.OnClickListener {
    ...
    public betting_dialouge2(@NonNull Context context, int themeResId) {
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.stake_500:
                ...
                price2.setText(String.valueOf(iprice));
                profit.setText(String.valueOf(iprice));
                price1.setText(String.valueOf("-" + istake));
