...
public class lay_dialouge1 extends Dialog implements View.OnClickListener {
    ...
    public lay_dialouge1(@NonNull Context context, int themeResId, String team1, String team2, String username, String balance,
            ...
            public void afterTextChanged(Editable s) {
                ...
                if (!s.toString().equals("")) {
                    ...
                    if (istake != 0) {
                        ...
                        if (stake_team.equals("1")) {
                            price1.setText(String.valueOf(Integer.parseInt(team1_win_lose) + Integer.parseInt("-" + iprice)));
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.place:
                ...
                if (stake_team.equals("1")) {
                    if (!MatchDetailsActivity.lay_1_rate.equals(srate)) {
                        Toast.makeText(mcontext, "rate changed try again", Toast.LENGTH_SHORT).show();
                        dismiss();
                        return;
                    }
                } else {
                    if (!MatchDetailsActivity.lay_2_rate.equals(srate)) {
                        Toast.makeText(mcontext, "rate changed try again", Toast.LENGTH_SHORT).show();
                        dismiss();
                        return;
                    }
    ...
    public void place_bet() {
        ...
        try {
            ...
            if (stake_team.equals("1")) {
                ...
                jsonObject.put("win2", sprice1);
                jsonObject.put("lose", sprice2);
            }
